...
// // import { createNewChatSession, getUserSessions, getSpecificSession, deleteChatSession, updateChatSessionTitle } from '@/actions/chatActions';
...
// //   const { messages, setMessages, handleSubmit, sendMessage, stop, status } = useChat({
// //     api: '/api/chat',
// //     body: {
// //       sessionId: session?.id,
// //       language: language === 'restored' ? 'english' : language,
...
// //         id: msg.id || uuidv4(),
// //         role: msg.role === 'model' ? 'assistant' : 'user', // useChat expects 'assistant' instead of 'model'
// //         content: msg.content
// //       })));
...
// //     };
// //     setMessages([{ id: uuidv4(), role: 'assistant', content: welcomeMessages[lang] || welcomeMessages.english }]);
// //   };
...
// //     sendMessage({ text: contentToSend }, { body: { sessionId: session.id, language, currentRoute: pathname } });
...
// //                   className={`group w-full text-left p-3 rounded-lg text-xs flex items-center justify-between gap-2 cursor-pointer transition-all border ${session?.id === s.id ? 'bg-white border-orange-200 shadow-sm' : 'border-transparent hover:bg-white hover:shadow-sm'
// //                     }`}
// //                 >
...
// //             isLoading={isChatLoading || isLoading}
...
//   const [language, setLanguage] = useState(null);
//   // Vercel AI SDK useChat Hook
//   const { messages, setMessages, input, setInput, handleSubmit, sendMessage, stop, status } = useChat({
//     api: '/api/chat',
//     body: {
//       sessionId: session?.id,
//       language: language === 'restored' ? 'english' : language,
